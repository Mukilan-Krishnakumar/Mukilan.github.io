        ...
        <div className="colorlib-narrow-content">
            ...
            <div className="col-md-4 text-center animate-box">
                ...
                <div className="desc">
                    ...
                    <p>I have built some websites. This website was built on my own with the help of few resources from the Internet</p>
                </div>
                </div>
            </div>
            <div className="col-md-4 text-center animate-box">
                ...
                <div className="desc">
                    ...
                    <p>As I come from a Comp Sci background, I have good grasp over fundamental concepts of DSA</p>
                </div>
                </div>
            </div>
            <div className="col-md-4 text-center animate-box">
                ...
                <div className="desc">
                    ...
                    <p>I am quite sufficient with TensorFlow and Keras. Building neural networks one at a time.</p>
                </div>
                </div>
            </div>
            <div className="col-md-4 text-center animate-box">
                ...
                <div className="desc">
                    <h3>Mobile Dev</h3>
                    <p>I am currently learning native development in iOS and Android </p>
                </div>
                </div>
            </div>
            <div className="col-md-4 text-center animate-box">
                ...
                <div className="desc">
                    <h3>Video Editing</h3>
                    <p>Using Darwin to create a cinematic experience</p>
                </div>
                </div>
            </div>
            <div className="col-md-4 text-center animate-box">
                ...
                <div className="desc">
                    <h3>Philosopher of sorts</h3>
                    <p>Universal implications of Absurdism through Camus's eyes</p>
                </div>
                </div>
            </div>
            </div>
